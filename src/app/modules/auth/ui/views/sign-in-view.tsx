                ...
                <CardContent className="grid p-0 md:grid-cols-2">
                    <Form {...form}>
                        ...
                        <form className="p-6 md:pd-8" onSubmit={form.handleSubmit(onSubmit)}>
                            <div className="flex flex-col gap-6">
                                <h1 className="text-2xl text-center font-semibold">Welcome to MeetAI</h1>
                                <h2 className="text-center text-muted-foreground">Login to your account</h2>
                                <FormField 
                                ...
                                <div className="text-center text-sm">
                                    ...
                                    <Link href="/sign-up" className="text-blue-400 underline underline-offset-2">Sign Up</Link>
                                </div>
                            </div>
                        </form>
                    </Form>
